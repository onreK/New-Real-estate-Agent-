    ...
    try {
      ...
      try {
        ...
        if (webChatResponse.ok) {
          ...
          console.log('Web Chat API failed:', webChatResponse.status);
        }
      } catch (webChatError) {
        console.log('Web Chat API error:', webChatError.message);
      }
      ...
      try {
        ...
        if (aiStatusResponse.ok) {
          ...
          console.log('AI Status API failed:', aiStatusResponse.status);
        }
      } catch (aiStatusError) {
        console.log('AI Status API error:', aiStatusError.message);
      }
      
      // 3. Load SMS data (with enhanced error handling)
      try {
        ...
        console.log('SMS API error:', smsError.message);
      }
