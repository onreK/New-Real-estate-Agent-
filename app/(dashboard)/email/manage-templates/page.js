...
{{agent_name}}
{{business_name}}`,
      variables: ['customer_name', 'business_name', 'agent_name', 'phone_number']
    },
    {
      name: 'Follow Up Check-in',
      category: 'follow_up',
      subject: 'Following up on your inquiry with {{business_name}}',
      content: `Hi {{customer_name}},

I hope this message finds you well! I wanted to follow up on our previous conversation about your needs.
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Use variables like {{customer_name}}, {{business_name}}, {{agent_name}}, {{phone_number}}
                      </p>
                    </div>
                  </>
                ) : (
