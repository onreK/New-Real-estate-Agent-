      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center justify-between">
                {[1, 2, 3].map((stepNumber, index) => (
                  <div key={stepNumber} className="flex items-center">
                    ...
                    {index < 2 && (
                      <div className={`w-16 h-1 mx-2 ${step > stepNumber ? 'bg-green-500' : 'bg-gray-300'}`} />
                    )}
                  </div>
                ))}
              </div>
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-4">
            <div className="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-lg text-white hover:bg-white/20 transition-colors cursor-pointer"
