// lib/ai-service.js - UPDATED WITH EVENT TRACKING
// Keep all your existing code and add these imports and modifications

import OpenAI from 'openai';
import { query } from './database.js';
import { trackBehaviorEvents } from './behavior-analyzer.js'; // 🎯 NEW IMPORT
...
// - getCustomerAIConfiguration
// - analyzeHotLead  
// - buildChannelSpecificPrompt
// - callOpenAI
...
async function callOpenAI(systemPrompt, userMessage, conversationHistory, customerConfig) {
  ...
  const completion = await openai.chat.completions.create({
    ...
    temperature: customerConfig?.temperature || customerConfig?.ai_temperature || 0.7
  });
