...
export async function checkEmailFilter(emailData, filterSettings) {
  ...
  if (headerCheck.isAutomated) {
    console.log('🚫 Automated email (header):', headerCheck.reason);
  ...
  if (senderCheck.isAutomated) {
    console.log('🚫 Automated email (sender):', senderCheck.reason);
  ...
  if (subjectCheck.isAutomated) {
    console.log('🚫 Transactional email (subject):', subjectCheck.reason);
  ...
  if (isMassEmail) {
    console.log('📧 Mass/newsletter email filtered');
